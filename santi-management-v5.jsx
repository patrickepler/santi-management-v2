...
// ============ USERS ============
const mockUsers = [
  { id: 1, email: 'john@santi.com', password: 'demo123', username: 'John Smith', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face', role: 'worker', managerId: 3 },
  { id: 2, email: 'sarah@santi.com', password: 'demo123', username: 'Sarah Chen', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop&crop=face', role: 'procurement', managerId: 3 },
  { id: 3, email: 'mike@santi.com', password: 'demo123', username: 'Mike Johnson', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face', role: 'manager', managerId: null },
];

const PROCUREMENT_USER_ID = 2; // Sarah Chen
const MANAGER_USER_ID = 3; // Mike Johnson

// ============ INITIAL DATA ============
const initialKanbanTasks = [
  { id: 'k1', title: 'Review site safety protocols', assignedTo: 1, column: 'today', dueDate: '2026-01-05', type: 'manual', createdAt: '2026-01-04' },
  { id: 'k2', title: 'Coordinate with architect on changes', assignedTo: 1, column: 'thisWeek', dueDate: '2026-01-08', type: 'manual', createdAt: '2026-01-03' },
  { id: 'k3', title: 'Order additional safety gear', assignedTo: 2, column: 'later', dueDate: '2026-01-15', type: 'manual', createdAt: '2026-01-02' },
  { id: 'k4', title: 'Weekly progress report', assignedTo: 3, column: 'thisWeek', dueDate: '2026-01-10', type: 'manual', createdAt: '2026-01-01' },
];

const initialRecurringTasks = [
  { id: 'r1', title: 'Daily safety inspection', assignedTo: 1, frequency: 'daily', days: [], specificDates: [], createdAt: '2026-01-01' },
  { id: 'r2', title: 'Weekly team standup', assignedTo: 3, frequency: 'weekly', days: ['Monday'], specificDates: [], createdAt: '2026-01-01' },
  { id: 'r3', title: 'Monthly inventory check', assignedTo: 2, frequency: 'monthly', days: ['1'], specificDates: [], createdAt: '2026-01-01' },
  { id: 'r4', title: 'Quarterly safety audit', assignedTo: 3, frequency: 'specific', days: [], specificDates: ['2026-03-01', '2026-06-01', '2026-09-01', '2026-12-01'], createdAt: '2026-01-01' },
];

const initialComments = {
  1: [{ id: 1, taskId: 1, userId: 2, text: 'Re-bar delivery confirmed', timestamp: '2026-01-04T09:30:00', mentions: [] }],
};
