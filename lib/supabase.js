...
export const db = {
  ...
  async loadAllData() {
    if (!supabase) {
      ...
      return { buildingTasks: [], kanbanTasks: [], recurringTasks: [], workforce: [], options: {}, buildingSequences: null, comments: {}, profiles: [] };
    }
    ...
    try {
      ...
      // Return data - buildingSequences is null so page.js uses its defaults
      return {
        buildingTasks,
        kanbanTasks,
        ...
        options,
        buildingSequences: null, // Let page.js use its default structure
        comments,
        profiles
      };
    } catch (err) {
